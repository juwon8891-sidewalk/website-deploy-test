...
class MobileScreen3 extends ConsumerStatefulWidget {
...
class SecondMobileScreenState extends ConsumerState<MobileScreen3> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    final provider = ref.read(mProviderManager).mobileScreenProvider3;
