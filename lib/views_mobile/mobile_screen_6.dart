...
class MobileScreen6 extends ConsumerStatefulWidget {
...
class SecondMobileScreenState extends ConsumerState<MobileScreen6> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    final provider = ref.read(mProviderManager).mobileScreenProvider6;
