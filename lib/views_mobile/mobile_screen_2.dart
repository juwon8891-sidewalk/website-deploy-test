...
class MobileScreen2 extends ConsumerStatefulWidget {
...
class SecondMobileScreenState extends ConsumerState<MobileScreen2> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    final provider = ref.read(mProviderManager).mobileScreenProvider2;
